  ...
  return (
    <header className="h-[56px] bg-[#0A0A0A] flex items-center justify-between px-4 shrink-0 z-[60] border-b border-white/5 shadow-2xl">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3 px-2.5 py-1.5 rounded-md bg-[#F7FAFC] transition-all duration-200 group cursor-pointer">

          {/* Avatar - shows org logo if available */}
          <div className="relative shrink-0">
            <div className="w-9 h-9 rounded-full bg-[#1A365D] flex items-center justify-center text-white text-xs font-semibold tracking-wide shadow-sm group-hover:shadow-md transition-all duration-200 overflow-hidden ">
              {loading ? (
