...
export function LoginPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-950 text-neutral-50 font-sans px-4 sm:px-0">
      ...
      <div className="w-full max-w-md">
        <Card className="p-6 sm:p-10">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription>
              Login with your Apple, Google account, or email
            </CardDescription>
          </CardHeader>
